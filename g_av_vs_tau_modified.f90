program main
    use coherence_gain_modified
    implicit none
    real :: t_time, tau_time, tau_time_start, tau_time_step, T_temp
    real :: p_plus, p_minus, p_plus_no_phase, p_minus_no_phase
    real :: D_plus, D_minus, D_t_minus_tau
    real :: g_av
    double complex :: W_tau, W_0, W_1, W_1_phased, W_2, W_2_phased, W_3
    ...
    filename = "g_av_vs_tau_T="//T_temp_string//"_"//t_time_string//"_"//tau_time_start_string &
        //"_"//tau_time_end_string//"_modified.dat"
    ...
    do iterator = 0, number_of_iterations
        ...
        call g_average(t_time,tau_time,T_temp,W_tau,W_0,W_1,W_1_phased,W_2,W_2_phased,W_3,&
            pure_phase,D_plus,D_minus,D_t_minus_tau,p_plus,p_minus, &
            p_plus_no_phase,p_minus_no_phase,g_av)

        write(1,*) tau_time, g_av, W_tau, W_0, W_1, W_1_phased, W_2, W_2_phased, W_3, &
            D_plus, D_minus, D_t_minus_tau, p_plus, p_minus, &
            p_plus_no_phase, p_minus_no_phase, pure_phase
    end do
