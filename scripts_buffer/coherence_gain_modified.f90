module coherence_gain_modified
    implicit none
...
subroutine g_average(t_time,tau_time,T_temp,W_tau,W_0,W_1,W_1_phased,W_2,W_2_phased,W_3, &
	pure_phase,D_plus,D_minus,D_t_minus_tau,p_plus,p_minus,p_plus_no_phase,p_minus_no_phase,g_av)
    implicit none
    real :: t_time, tau_time, T_temp
		real :: p_plus, p_minus, p_plus_no_phase, p_minus_no_phase
    real :: denominator_plus, denominator_minus
    real :: D_plus, D_minus, D_t_minus_tau
    real :: g_plus, g_minus, g_av
		real :: licznik_plus, licznik_minus, mianownik_plus, mianownik_minus
    double complex :: W_t_minus_tau, W_tau, W_0, W_1, W_1_phased, W_2, W_2_phased, W_3
    ...
    denominator_minus = abs(p_minus)
		...
		p_plus_no_phase = 0.5*(1 + real(W_tau))
		p_minus_no_phase = 0.5*(1 - real(W_tau))
...
end module coherence_gain_modified
