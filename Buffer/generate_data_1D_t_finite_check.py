...
def main():
    ...
    plt.legend()
    plt.grid()
    filename = 'Ds_T=' + str(T) + '_t=' + str(t) + '.pdf'
    ...
    plt.legend()
    plt.grid()
    filename = 'probabilities_T=' + str(T) + '_t=' + str(t) + '.pdf'
    plt.savefig(filename)
    # plt.show()
    ...
    plt.xlabel(r'$\tau$')
    plt.grid()
    filename = 'g_av_T=' + str(T) + '_t=' + str(t) + '.pdf'
    plt.savefig(filename)
    # plt.show()
    ...
    plt.grid()
    plt.legend()
    filename = 'components_real_T=' + str(T) + '_t=' + str(t) + '.pdf'
    plt.savefig(filename)
    # plt.show()
    ...
    plt.grid()
    plt.legend()
    filename = 'components_imag_T=' + str(T) + '_t=' + str(t) + '.pdf'
    plt.savefig(filename)
    # plt.show()
