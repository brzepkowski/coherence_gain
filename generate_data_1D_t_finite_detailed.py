...
def main():
    ...
    for tau in taus:
        ...
        results_phase_W_0_real.append(W_0.real)
        results_phase_W_0_imag.append(W_0.imag)
        results_phase_W_1_real.append(phase_W_1.real)
        results_phase_W_1_imag.append(phase_W_1.imag)
        results_phase_W_2_real.append(phase_W_2.real)
        results_phase_W_2_imag.append(phase_W_2.imag)
        results_phase_W_3_real.append(W_3.real)
        results_phase_W_3_imag.append(W_3.imag)
    ...
    plt.figure(figsize=(25,4))
    plt.plot(taus, results_phase_W_0_real, "-", label=r'$\langle W(t-\tau)\rangle$')
    plt.plot(taus, results_phase_W_1_real, "-", label=r'$e^{-iE\tau/\hbar} \langle W(t-\tau) W^\dagger(\tau)\rangle$')
    plt.plot(taus, results_phase_W_2_real, "-", label=r'$e^{iE\tau/\hbar} \langle W(\tau)W(t-\tau)\rangle$')
    plt.plot(taus, results_phase_W_3_real, "-", label=r'$\langle W(\tau) W(t-\tau) W^\dagger(\tau) \rangle$')
    ...
    plt.figure(figsize=(25,4))
    plt.plot(taus, results_phase_W_0_imag, "-", label=r'$\langle W(t-\tau)\rangle$')
    plt.plot(taus, results_phase_W_1_imag, "-", label=r'$e^{-iE\tau/\hbar} \langle W(t-\tau) W^\dagger(\tau)\rangle$')
    plt.plot(taus, results_phase_W_2_imag, "-", label=r'$e^{iE\tau/\hbar} \langle W(\tau)W(t-\tau)\rangle$')
    plt.plot(taus, results_phase_W_3_imag, "-", label=r'$\langle W(\tau) W(t-\tau) W^\dagger(\tau) \rangle$')
    ...
    plt.plot(taus, results_W_1_real, "-", label=r'$\langle W(t-\tau) W^\dagger(\tau)\rangle$')
    plt.plot(taus, results_W_2_real, "-", label=r'$\langle W(\tau)W(t-\tau)\rangle$')
    ...
    plt.grid()
    plt.legend()
    filename = 'components_no_phase_real_T=' + str(T) + '_t=' + str(t) + '_tau_min=' + str(tau_min) + '_tau_max=' + str(tau_max) + '.pdf'
    plt.savefig(filename)
    # plt.show()
    ...
    plt.plot(taus, results_W_1_imag, "-", label=r'$\langle W(t-\tau) W^\dagger(\tau)\rangle$')
    plt.plot(taus, results_W_2_imag, "-", label=r'$\langle W(\tau)W(t-\tau)\rangle$')
    ...
    plt.grid()
    plt.legend()
    filename = 'components_no_phase_imag_T=' + str(T) + '_t=' + str(t) + '_tau_min=' + str(tau_min) + '_tau_max=' + str(tau_max) + '.pdf'
    plt.savefig(filename)
    # plt.show()
