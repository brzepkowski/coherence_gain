program main
    ...
    filename = "g_av_vs_tau_extended_info_T="//T_temp_string//"_"//t_time_string//"_" &
          //tau_time_start_string//"_"//tau_time_end_string//".dat"
    ...
    do iterator = 0, number_of_iterations
        ...
        write(1,*) tau_time, W_0, W_1, W_1_phased, W_2, W_2_phased, W_3, phase, &
            D_plus,D_minus,D_t,p_plus,p_minus,g_av
    end do
